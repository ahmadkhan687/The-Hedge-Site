    ...
    <section className="bg-[#F5F0E8] pb-8 lg:pb-12">
      <div className="px-5 sm:px-8 lg:px-20">
        <div className="mx-auto flex w-full max-w-[1568px] flex-col gap-8 lg:flex-row lg:items-start lg:justify-center lg:gap-12">
          ...
          <Link
            href="/sovereignty"
            className="hidden h-[120px] w-[220px] shrink-0 flex-col gap-2 rounded-sm border border-[#2C2A26] bg-[#F5F0E8] p-3 text-inherit no-underline transition-opacity hover:opacity-70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#C6A02C] lg:flex"
          >
